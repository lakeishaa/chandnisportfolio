// <![CDATA[
var colour = "#f83b8a"; // in addition to "random" can be set to any valid colour eg "#f0f" or "red"
var sparkles = 50;
...
window.onload = function () {
  if (document.getElementById) {
    ...
    for (var i = 0; i < sparkles; i++) {
      var rats = createDiv(23, 23);
      rats.style.visibility = "hidden";
      document.body.appendChild((tiny[i] = rats));
      starv[i] = 0;
      tinyv[i] = 0;
      var rats = createDiv(25, 25);
      rats.style.backgroundColor = "transparent";
      rats.style.visibility = "hidden";
      var rlef = createDiv(1, 25);
      var rdow = createDiv(25, 1);
